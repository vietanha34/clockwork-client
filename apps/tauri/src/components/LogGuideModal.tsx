        ...
        <div className="space-y-3 text-xs text-amber-950">
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              onClick={() =>
                open(
                  'https://drive.google.com/file/d/1fP8sUz6zAjVHbEZnpwS982ERRoXVv2Ld/view?usp=sharing',
                )
              }
            ...
            <button
              ...
              onClick={() =>
                open(
                  'https://drive.google.com/file/d/1iWE1r7ZXlY_umPXxNJGeq4qI9FCx6H4R/view?usp=drive_link',
                )
              }
              className="flex items-center justify-between rounded border border-amber-300 bg-white px-3 py-2 hover:bg-amber-50 text-left transition-colors"
            >
          ...
          <section className="pt-2 border-t border-amber-200">
            ...
            <p className="mt-1">
              Sau khi log bù xong, vui lòng nhấn nút <strong>Reload</strong> ở danh sách worklogs để
