...
description: "Execute and resume implementation tasks from Conductor track plans with strict workflow enforcement (TDD flow, verification checkpoints, commit strategy, and metadata synchronization). Use when asked to implement a track, continue pending tasks/phases, or run task-by-task delivery from conductor/tracks/*/plan.md."
---

# Implement Track

Input hint: `[track-id] [--task X.Y] [--phase N]`
